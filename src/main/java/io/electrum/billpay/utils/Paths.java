...
public class Paths {
   ...
   public static final String REQUEST_TRAFFIC_FINE_INFO = ACCOUNT_LOOKUP_BASE_PATH + "/traffic/{" + PathParams.REQUEST_ID + "}";
   public static final String REQUEST_POLICY_INFO = ACCOUNT_LOOKUP_BASE_PATH + "/policy/{" + PathParams.REQUEST_ID + "}";
   ...
   public static final String CREATE_TRAFFIC_FINE_PAYMENT = PAYMENTS_BASE_PATH +"/traffic/{" + PathParams.PAYMENT_ID + "}";
   public static final String CREATE_ACCOUNT_PAYMENT = PAYMENTS_BASE_PATH +"/{" + PathParams.PAYMENT_ID + "}";
   public static final String CONFIRM_PAYMENT = PAYMENTS_BASE_PATH +
         "/{" + PathParams.PAYMENT_ID + "}/confirmations/{" + PathParams.ADVICE_ID + "}";
   public static final String REVERSE_PAYMENT = PAYMENTS_BASE_PATH +
   ...
   public static final String CONFIRM_REFUND = REFUNDS_BASE_PATH + "/{" + PathParams.REFUND_ID + "}/confirmations/{" + PathParams.ADVICE_ID + "}";
   public static final String REVERSE_REFUND = REFUNDS_BASE_PATH + "/{" + PathParams.REFUND_ID + "}/reversals/{" + PathParams.ADVICE_ID + "}";
}